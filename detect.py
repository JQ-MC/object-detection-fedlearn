...
@torch.no_grad()
def run(
    weights=ROOT / "runs/train/exp2_400_epochs/weights/best.pt",  # model.pt path(s)
    source=ROOT / "data/datasets/camacuc/images",  # file/dir/URL/glob, 0 for webcam
...
def parse_opt():
    ...
    parser.add_argument(
        ...
        nargs="+",
        type=str,
        default=ROOT / "runs/train/exp2_400_epochs/weights/best.pt",
        help="model path(s)",
    )
    parser.add_argument(
        "--source",
        type=str,
        default=ROOT / "data/datasets/camacuc/images",
